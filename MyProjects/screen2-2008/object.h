...
private:
	...
	void DrawPolySimple(POLYGON *currentpoly);
	...
	void DrawSpanSimple(int startx,int endx,int y);
...
public:
	...
	VECTOR *Vectors;		// 
	VECTOR *RVectors;
	VECTORint *RVectorsint;
	VECTOR *TVectors;			// Transformed vectors
	VECTORint *TVectorsint;		// Transformed vectors

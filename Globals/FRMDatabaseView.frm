...
Private Sub CMDOpen_Click()
    ...
    Dim notused() As InlineSQLTYPE
    tempstring = txtSQL.Text
    Call StripTags(tempstring, notused)
    
    On Error GoTo failed
    ADOControl.RecordSource = tempstring
    Call ADOControl.Refresh
    Exit Sub
failed:
    Call Messagebox("ERROR:" & Error$, vbCritical + vbOKOnly)
End Sub
